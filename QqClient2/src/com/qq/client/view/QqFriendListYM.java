...
public class QqFriendListYM extends JFrame implements ActionListener,MouseListener{
	...
	public static void main(String[] args) {
		...
		QqFriendListYM qqFriendListYM =new QqFriendListYM("123");
	}
	...
	public QqFriendListYM(String ownerId)
	{
		this.owner=ownerId;
		//处理第一张卡片(显示好友列表)
